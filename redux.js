(function() {
  ...
  angular.module('ngRedux', [])
    ...
    .provider('Redux', function ReduxProvider() {
      var globalStore = {};
      var reduxEngine = new ReduxEngine();
      this.$get = function ReduxFactory() {
        return globalStore.store;
      }
      this.createStore = function(reducer, initialState) {
        globalStore.store = reduxEngine.createStore(reducer, initialState);
      }
      this.combineReducers = reduxEngine.combineReducers;
    })
